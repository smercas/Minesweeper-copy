...
namespace Minesweeper
{
    class MinefieldBackdrop : UserControl
    {
        ...
        private static bool blockedInteraction = false;
        #endregion
        ...
        private byte[] minesHidden = new byte[3];
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (System.ComponentModel.LicenseManager.UsageMode != System.ComponentModel.LicenseUsageMode.Designtime)
            {
                ...
                if (_gameState == GAME_OVER_WON)
                {
                    e.Graphics.DrawImage(NumberfieldSuccessText, new Rectangle(18, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[0]], 13, 23), GraphicsUnit.Pixel);
                    e.Graphics.DrawImage(NumberfieldSuccessText, new Rectangle(31, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[1]], 13, 23), GraphicsUnit.Pixel);
                    e.Graphics.DrawImage(NumberfieldSuccessText, new Rectangle(44, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[2]], 13, 23), GraphicsUnit.Pixel);
                }
                else
                {
                    e.Graphics.DrawImage(NumberfieldText, new Rectangle(18, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[0]], 13, 23), GraphicsUnit.Pixel);
                    e.Graphics.DrawImage(NumberfieldText, new Rectangle(31, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[1]], 13, 23), GraphicsUnit.Pixel);
                    e.Graphics.DrawImage(NumberfieldText, new Rectangle(44, 16, 13, 23), new Rectangle(0, numbercoords[minesHidden[2]], 13, 23), GraphicsUnit.Pixel);
                }
